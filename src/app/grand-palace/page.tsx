    ...
    return (
        <div className="min-h-screen bg-stone-50 font-sans text-stone-900 selection:bg-bronze-200 selection:text-bronze-900">
                            ...
                            <div className="lg:w-2/3">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                                    {[
                                        ...
                                        { label: "Projeto Arquitetônico", value: "Bernardo Concept" },
            ...
            <a
                ...
                className="fixed bottom-8 right-8 z-50 w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center transition-all duration-500 hover:scale-110 shadow-2xl hover:shadow-[#25D366]/40 animate-bounce"
